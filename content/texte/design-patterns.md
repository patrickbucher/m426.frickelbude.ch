+++
date = '2026-05-03T17:51:30+02:00'
title = 'Entwurfsmuster'
weight = 7
+++

## Problem: Inkompatible Implementierungen

Betrachten wir das folgende Klassendiagramm, welches eine C#-Anwendung für geometrische Berechnungen zeigt:

![Klassendiagramm: Wie bringt man das Quadratische durch das Rechteckige?](/images/design-patterns/adapter-problem.png)
...
![Klassendiagramm: Das Adapter-Entwurfsmuster](/images/design-patterns/adapter-solution.png)
